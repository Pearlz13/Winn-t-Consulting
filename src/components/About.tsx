      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            We have done corporate and consulting roles in our careers across countries.<br></br> In all our roles, we attempted to keep conversations simple and direct to accelerate change projects. We offer capacity building solutions on CHANGE to our clients in India and internationally. 
          </p>
        </div>
